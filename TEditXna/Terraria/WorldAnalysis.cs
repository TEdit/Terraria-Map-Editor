...
namespace TEditXNA.Terraria
{
    public static class WorldAnalysis
    {
        ...
        private static void WriteFlags(StringBuilder sb, World world)
        {
            ...
            sb.Write("world.TreeX[0]", world.TreeX0);
            sb.Write("world.TreeX[1]", world.TreeX1);
            sb.Write("world.TreeX[2]", world.TreeX2);
            sb.Write("world.TreeStyle[0]", world.TreeStyle0);
            sb.Write("world.TreeStyle[1]", world.TreeStyle1);
            sb.Write("world.TreeStyle[2]", world.TreeStyle2);
            sb.Write("world.TreeStyle[3]", world.TreeStyle3);
            sb.Write("world.CaveBackX[0]", world.CaveBackX0);
            sb.Write("world.CaveBackX[1]", world.CaveBackX1);
            sb.Write("world.CaveBackX[2]", world.CaveBackX2);
            sb.Write("world.CaveBackStyle[0]", world.CaveBackStyle0);
            sb.Write("world.CaveBackStyle[1]", world.CaveBackStyle1);
            sb.Write("world.CaveBackStyle[2]", world.CaveBackStyle2);
            sb.Write("world.CaveBackStyle[3]", world.CaveBackStyle3);
