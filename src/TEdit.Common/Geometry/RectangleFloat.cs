...
public struct RectangleFloat : IEquatable<RectangleFloat>
{
    ...
    //
    // Summary:
    //     Returns a Microsoft.Xna.Framework.RectangleFloat with X=0, Y=0, Width=0, Height=0.
    public static RectangleFloat Empty => emptyRectangle;
    ...
    //
    // Summary:
    //     Whether or not this Microsoft.Xna.Framework.RectangleFloat has a Microsoft.Xna.Framework.Rectangle.Width
    ...
    public Vector2Float Center => new Vector2Float(X + Width / 2, Y + Height / 2);

    internal string DebugDisplayString => X + "  " + Y + "  " + Width + "  " + Height;

    //
    // Summary:
    //     Creates a new instance of Microsoft.Xna.Framework.RectangleFloat struct, with the
    ...
    public RectangleFloat(Vector2Int32 location, Vector2Int32 size)
    {
        X = location.X;
        Y = location.Y;
        Width = size.X;
    ...
    //
    // Summary:
    //     Compares whether two Microsoft.Xna.Framework.RectangleFloat instances are equal.
    //
    // Parameters:
    //   a:
    //     Microsoft.Xna.Framework.RectangleFloat instance on the left of the equal sign.
    //
    //   b:
    //     Microsoft.Xna.Framework.RectangleFloat instance on the right of the equal sign.
    //
    // Returns:
    ...
    //
    // Summary:
    //     Compares whether two Microsoft.Xna.Framework.RectangleFloat instances are not equal.
    //
    // Parameters:
    //   a:
    //     Microsoft.Xna.Framework.RectangleFloat instance on the left of the not equal sign.
    //
    //   b:
    //     Microsoft.Xna.Framework.RectangleFloat instance on the right of the not equal sign.
    //
    // Returns:
    ...
    //
    // Summary:
    //     Gets whether or not the provided Microsoft.Xna.Framework.RectangleFloat lies within
    //     the bounds of this Microsoft.Xna.Framework.Rectangle.
    //
    // Parameters:
    //   value:
    //     The Microsoft.Xna.Framework.RectangleFloat to check for inclusion in this Microsoft.Xna.Framework.Rectangle.
    //
    // Returns:
    ...
    //     parameter.
    public void Contains(ref RectangleFloat value, out bool result)
    {
    ...
    // Parameters:
    //   other:
    //     The Microsoft.Xna.Framework.RectangleFloat to compare.
    //
    // Returns:
    //     true if the instances are equal; false otherwise.
    ...
    //
    // Summary:
    //     Adjusts the edges of this Microsoft.Xna.Framework.RectangleFloat by specified horizontal
    ...
    //
    // Summary:
    //     Gets whether or not the other Microsoft.Xna.Framework.RectangleFloat intersects with
    //     this rectangle.
    //
    // Parameters:
    //   value:
    //     The other RectangleFloat for testing.
    //
    // Returns:
    //     true if other Microsoft.Xna.Framework.RectangleFloat intersects with this rectangle;
    //     false otherwise.
    ...
    //
    // Summary:
    //     Creates a new Microsoft.Xna.Framework.RectangleFloat that contains overlapping region
    ...
    public static bool Intersect(ref RectangleFloat value1, ref RectangleFloat value2, out RectangleFloat result)
    {
        ...
        {
            result = new RectangleFloat(0, 0, 0, 0);
            return false;
        }
    }
    ...
    //
    // Summary:
    //     Creates a new Microsoft.Xna.Framework.RectangleFloat that completely contains two
    //     other rectangles.
    //
    // Parameters:
    //   value1:
