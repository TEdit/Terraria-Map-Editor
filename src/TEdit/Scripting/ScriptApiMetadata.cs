...
public static class ScriptApiMetadata
{
    ...
    [
        ...
        [
            ...
            new("getTileEcho",      "getTileEcho(x, y) → bool",      "Check if tile has echo (invisible) coating"),
            new("getWallEcho",      "getWallEcho(x, y) → bool",      "Check if wall has echo (invisible) coating"),
            new("getTileIlluminant", "getTileIlluminant(x, y) → bool", "Check if tile has illuminant (full bright) coating"),
            new("getWallIlluminant", "getWallIlluminant(x, y) → bool", "Check if wall has illuminant (full bright) coating"),
            ...
            new("setTileEcho",      "setTileEcho(x, y, value)",       "Set tile echo (invisible) coating"),
            new("setWallEcho",      "setWallEcho(x, y, value)",       "Set wall echo (invisible) coating"),
            new("setTileIlluminant", "setTileIlluminant(x, y, value)", "Set tile illuminant (full bright) coating"),
            new("setWallIlluminant", "setWallIlluminant(x, y, value)", "Set wall illuminant (full bright) coating"),
