    ...
    public static class TileProperties
    {
        ...
        static TileProperties()
        {
            ...
            var frameImportant = new[]
                                     {
                                         3,5,10,11,12,13,14,15,16,17,18,20,21,24,26,27,28,29,31,33,34,35,36,42,50,55,61,71,72,73,74,77,78,79,81,82,83,84,85
                                     };
            var lighted = new[]
                              {
                                  0, 1, 2, 6, 7, 8, 9, 10, 22, 23, 25, 30, 32, 37, 38, 39, 40, 41, 43, 44, 45, 46, 47,
                                  48,
